...
const N8nConfig: React.FC<N8nConfigProps> = ({ onConfigChange }) => {
  ...
  useEffect(() => {
    ...
    if (savedConfig) {
      ...
      setWebhookUrl(config.webhookUrl || 'https://tunz123456.app.n8n.cloud/webhook/restaurant-chat');
      setApiKey(config.apiKey || '');
    } else {
      // Set default webhook URL
      setWebhookUrl('https://tunz123456.app.n8n.cloud/webhook/restaurant-chat');
    }
  }, []);
    ...
    <div style={{ padding: '20px', maxWidth: '500px' }}>
      ...
      <div style={{ marginBottom: '15px' }}>
        ...
        <input
          ...
          placeholder="https://tunz123456.app.n8n.cloud/webhook/restaurant-chat"
          style={{ 
            width: '100%', 
            padding: '8px', 
            borderRadius: '4px', 
